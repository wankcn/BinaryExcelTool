...
public class BinaryDataManager
{
    ...
    public void Save(object obj, string fileName)
    {
        ...
        using (FileStream fs = new FileStream(SAVE_PATH + fileName + ".wr", FileMode.OpenOrCreate, FileAccess.Write))
        {
    ...
    public T Load<T>(string fileName) where T : class
    {
        ...
        T obj;
        using (FileStream fs = File.Open(SAVE_PATH + fileName + ".wr", FileMode.Open, FileAccess.Read))
        {
            BinaryFormatter bf = new BinaryFormatter();
